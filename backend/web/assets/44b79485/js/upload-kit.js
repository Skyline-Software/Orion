    ...
    jQuery.fn.yiiUploadKit = function(options) {
        ...
        var methods = {
            ...
            createItem: function(file){
                ...
                console.log(options);
                console.log(file.delete_url);
                console.log('test');
                console.log(typeof file.delete_url === 'undefined');
                ...
                if(typeof file.delete_url === 'undefined'){
                    item.append($('<span/>', {"class": "glyphicon glyphicon-remove-circle remove", "data-url": "/file-storage/upload-delete?path="+encodeURIComponent(file[options.pathAttribute])}));
                }else{
                    item.append($('<span/>', {"class": "glyphicon glyphicon-remove-circle remove", "data-url": file.delete_url}));
                }
